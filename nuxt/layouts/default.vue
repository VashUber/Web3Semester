<template>
  <v-app>
    ...
    <v-footer class="d-flex justify-center" color="grey darken-4">
      <a href="https://github.com/VashUber" class="text-decoration-none white--text">GitHub</a>
    </v-footer>
  </v-app>
</template>
...
<style scoped>
  .nuxt-link-exact-active:not(:first-child) {
    background: #000;
  }
</style>
